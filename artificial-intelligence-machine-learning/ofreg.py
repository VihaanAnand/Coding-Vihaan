...
def overfitting():
       ...
       print("Linear:")
       loss(y_test, y_pred_linear, model_linear)
       print("\nPolynomial (Overfit):")
       loss(y_test, y_pred_poly, model_poly)
       print(f"\n    Linear Model Complexity:  {len(model_linear.coef_)} coefficient/s")
       print(f"Polynomial Model Complexity: {len(model_poly.coef_)} coefficient/s\n")
